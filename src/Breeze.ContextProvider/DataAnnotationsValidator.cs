...
namespace Breeze.ContextProvider
{
    public class DataAnnotationsValidator
    {
        ...
        // WB: Not used by EF or NH except in edge test cases that we won't try to support in Core now (if ever)
        public static void AddDescriptor(Type entityType, Type metadataType)
        {
#if DNXCORE50
            throw new NotImplementedException("Not supported in dnxCore");
#else
