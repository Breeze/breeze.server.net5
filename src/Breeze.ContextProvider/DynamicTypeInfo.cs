...
#region public statics 
        ...
        private static string CalcStringHash(string stringToHash, int maxChars)
        {
            ...
            byte[] hash = Encoding.Unicode.GetBytes(stringToHash);

#if !DNXCORE50
            // WB: Core doesn't have any Crytography support at the moment
            // WHO KNOWS what will happen if we skip this step?
        ...
        {
#if DNXCORE50
            throw new NotImplementedException("Core doesn't support dynamic type creation");
#else
            ...
            AddToMap(this);
            System.Diagnostics.Trace.WriteLine("DynamicType constructed " + this.DynamicTypeName);
#endif
        }
        ...
        private ConstructorInfo _dynamicConstructorInfo = null;
        private ConstructorInfo _dynamicEmptyConstructorInfo = null;
